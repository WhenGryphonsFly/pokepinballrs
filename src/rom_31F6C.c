...
void sub_31F6C(void) {
    ...
    s32 currentSpecies;
    s32 currentWeight;
    s32 currentPokedexFlag;
    s32 potentialPokedexFlag;
    s32 threeArrows;
    u16 selectedWeight;
    ...
    for (i = 0; i < 8; gUnknown_020314E0->unk12E += currentWeight, gUnknown_020314E0->unk130[i] = gUnknown_020314E0->unk12E, i++) {
        currentSpecies = gWildMonLocations[gUnknown_020314E0->area][threeArrows][i];
        currentWeight = 0;
        if (currentSpecies >= SPECIES_NONE) continue;
        if (currentSpecies == gUnknown_020314E0->unk59C) continue;
        currentPokedexFlag = 4;
        
        if (currentSpecies == SPECIES_CLAMPERL) {
            for (; currentSpecies <= SPECIES_GOREBYSS; currentSpecies++) {
                potentialPokedexFlag = gMain_saveData.pokedexFlags[currentSpecies];
                if (currentPokedexFlag > potentialPokedexFlag) currentPokedexFlag = potentialPokedexFlag;
            }
        } else {
            for (; currentSpecies < SPECIES_NONE; currentSpecies = gUnknown_086A3700[currentSpecies].evolutionTarget) {
                potentialPokedexFlag = gMain_saveData.pokedexFlags[currentSpecies];
                if (currentPokedexFlag > potentialPokedexFlag) currentPokedexFlag = potentialPokedexFlag;
            }
        }
        ...
        if (currentPokedexFlag >= 4) currentWeight = 1;
    }

    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0;");
    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0");
    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0");
    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0");
    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0");
    asm_unified("movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0; movs r0, r0");
